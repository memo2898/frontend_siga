...
interface ToastXProps {
  toast: Toast;
  onRemove: (id: string) => void;
  index: number;
}

export const ToastX: React.FC<ToastXProps> = ({ toast, onRemove, index }) => {
  const [isPaused, setIsPaused] = useState(false);
  const [progress, setProgress] = useState(100);
  //Cannot find namespace 'NodeJS'
const timerRef = useRef<ReturnType<typeof setInterval> | null>(null);  //const timerRef = useRef<NodeJS.Timeout | null>(null);
