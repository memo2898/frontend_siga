...
interface TransaccionesDeleteModalProps {
  isOpen: boolean;
...
export function TransaccionesDeleteModal({ isOpen, transacciones, loading, onConfirm, onCancel }: TransaccionesDeleteModalProps) {
  ...
  return (
    ...
    >
      <p style={ { marginBottom: 16 } }>
        ¿Estás seguro que deseas eliminar el siguiente transacciones?
      </p>
      <div style={ {
        padding: 16,
        ...
        <strong>{ transacciones.codigo }</strong>
        <br />
        <span style={ { color: '#6b7280', fontSize: 14 } }>
          { transacciones.modulo_id }
        </span>
      </div>
