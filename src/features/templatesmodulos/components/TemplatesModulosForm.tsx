...
interface TemplatesModulosFormProps {
  initialData?: TemplatesModulos | null;
  onSubmit: (data: { nombre: string; descripcion: string; contenido_hbs: string; variables_utilizadas: any }) => void;
  onCancel: () => void;
  loading?: boolean;
}

export function TemplatesModulosForm({ initialData, onSubmit, onCancel, loading }: TemplatesModulosFormProps) {
