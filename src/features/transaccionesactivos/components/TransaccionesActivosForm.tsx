...
import './TransaccionesActivosForm.css';

interface TransaccionesActivosFormProps {
  initialData?: TransaccionesActivos | null;
...
export function TransaccionesActivosForm({ initialData, onSubmit, onCancel, loading, transaccionesOptions, activosOptions }: TransaccionesActivosFormProps) {
